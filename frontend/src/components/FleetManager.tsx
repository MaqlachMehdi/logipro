                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <h4 className={`font-medium ${vehicle.isAvailable === false ? 'text-gray-400' : 'text-gray-900'}`}>{vehicle.name}</h4>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`text-xs ${vehicle.isAvailable === false ? 'text-gray-400' : 'text-gray-600'}`}>
                        {vehicle.capacity}m³
                      </span>
                    </div>
                  </div>
