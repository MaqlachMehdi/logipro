  ...
  return (
    <Card className="bg-white border-gray-200">
      ...
      <CardContent className="space-y-6">
        {/* Itineraire */}
        <div>
          <h3 className="text-sm font-semibold text-gray-800 mb-3">Itinéraire</h3>
          <div className="space-y-2">
            {legs.map((leg, idx) => (
              <div key={idx} className="flex items-center gap-3 text-xs">
                <div className="flex-1">
                  <p className="text-gray-800 font-medium">{leg.from}</p>
                  <p className="text-gray-600">↓</p>
                  <p className="text-gray-800 font-medium">{leg.to}</p>
                </div>
        ...
        {/* Instruments */}
        <div>
          <h3 className="text-sm font-semibold text-gray-800 mb-3">Instruments transportés</h3>
