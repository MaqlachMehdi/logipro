          ...
          {spots.map((spot) => {
            ...
            >
              <div className="flex items-start justify-between">
                ...
                {!isDepot && (
                  <button
                    className="hover:bg-red-50 h-8 w-8 p-0 rounded flex items-center justify-center transition-colors"
                    ...
                    type="button"
                  >
                    <Trash2 className="w-4 h-4" style={{ color: '#000000', stroke: '#000000' }} />
                  </button>
                )}
              </div>
            </div>
