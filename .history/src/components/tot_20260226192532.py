...
def main_json():
    ...
    try:
        ...
        log_message("[DONNEES RECUES]")
        log_message(f"  - Lieux: {len(df_Lieux)}")
        log_message(f"  - Instruments: {len(df_Instruments)}")
        log_message(f"  - Vehicules: {len(df_Vehicules)}")
        log_message(f"  - Configuration: {selected_config}")
        log_message("")
