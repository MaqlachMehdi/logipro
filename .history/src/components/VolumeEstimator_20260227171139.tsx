      ...
      <CardHeader className="pb-3">
        <CardTitle className="text-gray-900 text-sm flex items-center justify-between">
          ...
          <div className="relative flex items-center gap-2">
            ...
            <Button
              size="sm"
              className="h-6 w-6 p-0 bg-black hover:bg-black text-white"
              onClick={() => {
            ...
            {isAddMenuOpen && (
              <div className="absolute right-0 top-8 z-20 w-72 rounded-lg border border-gray-200 bg-white p-3 shadow-lg">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2 pt-1">
                    <Button size="sm" className="h-8 flex-1" onClick={handleAddGear}>
                      Ajouter
                    </Button>
                    <Button
                      size="sm"
