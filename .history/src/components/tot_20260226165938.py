...
def main_json():
    ...
    try:
        ...
        # 5. INITIALISATION DU GESTIONNAIRE
        manager = SolutionManager()
        
        # 6. CONFIGURATIONS À TESTER
        configurations = [
            {
                'label': 'Équilibré',
        ...
        # 7. RÉSOLUTION DES CONFIGURATIONS
        ...
        # 8. RETOURNER LES RÉSULTATS EN JSON
        result = {
            'success': True,
            'solutions': manager.solutions,
            'best_solution': manager.best_solution
        }
