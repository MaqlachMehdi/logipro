          ...
          <div className="col-span-1 space-y-6">
            <div className="space-y-3">
              <div className="flex gap-2">
                <Button
                  size="sm"
                  className={`flex-1 ${state.showLoadIn ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-gray-100 hover:bg-gray-200 text-gray-700 border border-gray-300'}`}
                ...
                <Button
                  size="sm"
                  className={`flex-1 ${state.showLoadOut ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-gray-100 hover:bg-gray-200 text-gray-700 border border-gray-300'}`}
