import { useReducer } from 'react';
                <Button
                  size="sm"
                  className={`flex-1 ${state.showLoadIn ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-white border border-gray-200 text-blue-600 hover:bg-blue-50'}`}
                ...
                <Button
                  size="sm"
                  className={`flex-1 ${state.showLoadOut ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-white border border-gray-200 text-blue-600 hover:bg-blue-50'}`}
