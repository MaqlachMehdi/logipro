...
# Load data
data_path = os.path.join(project_root, "backend", "solver", "vrppd_data.json")
...
output_file = os.path.join(project_root, "backend", "solver", "solution", "convergence_debug.html")
try:
