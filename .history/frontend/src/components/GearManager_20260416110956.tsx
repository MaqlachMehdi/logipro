  ...
  return (
    <Card className="bg-white border-gray-200 text-gray-900">
      ...
      <CardContent className="space-y-4">
            ...
            gearCatalog.map((gear) => (
              ...
              >
                <div className="min-w-0">
                  ...
                  <span className="number_subtitle block">{gear.category ? `${gear.category} · ` : ''}{gear.volume}m³</span>
                </div>
        ...
        {/* Formulaire d'ajout (affiché en toggle) */}
        {isAdding && (
          <div className="grid grid-cols-1 gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div className="space-y-1">
              ...
              <Input
                id="gear-category"
                placeholder="Ex: Clavier, Percussion…"
                value={newCategory}
        ...
        {/* Bouton d'ajout style SpotManager */}
        {!isAdding && (
