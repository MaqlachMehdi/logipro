    ...
    if args.api:
        ...
        try:
            ...
            for plate, trajectory in result.data.items():
                ...
                t_dep = result.get_depot_departure_time(plate)
                t_arr = result.get_depot_arrival_time(plate)
                vehicle_time = (t_arr - t_dep) if (t_arr is not None and t_dep is not None) else 0.0
                ...
                details_vehicules.append({
                    ...
                    'temps_min': round(vehicle_time, 1),
