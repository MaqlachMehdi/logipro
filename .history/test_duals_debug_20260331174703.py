...
# We're running from backend/solver directory
# Add parent-parent directory (backend/) to sys.path
script_dir = os.path.dirname(os.path.abspath(__file__))  # c:\logipro\backend\solver
backend_dir = os.path.dirname(script_dir)  # c:\logipro\backend
...
# Load data
data_path = os.path.join(script_dir, "vrppd_data.json")
...
output_file = os.path.join(script_dir, "solution", "convergence_debug.html")
try:
